...
import type { AiPromptResponse, Chart, CreateSongRequest, Song } from '../types'
...
export const contentApi = {
  ...
  createChart: (body: { songId: number; mode: string; difficulty?: string; patternData: object }) =>
    http.post<Chart>('/charts', body),
