...
export const GAME_CATALOG: GameEntry[] = [
  ...
  {
    id: 'fish', gameId: 11, name: '모션 낚시', tag: '던지고 · 노리고 · 감아올리기', emoji: '🎣', thumb: '#e0f1fb', playable: true,
    description: '낚싯대를 휘둘러 미끼를 던지고, 양손 높이로 미끼 깊이를 조절해 노리는 어종의 층을 고르는 낚시 게임이에요. 입질이 오면 챔질하고 릴을 감아 올려요 — 깊은 곳일수록 귀한 물고기!',
    howToPlay: ['양손으로 대를 쥐고 뒤로 젖힌 뒤, 좌우로 조준하고 앞으로 휘둘러 던져요', '기다리는 동안 양손 높이로 미끼 깊이를 조절해요 — 멸치는 얕게, 상어는 깊게', '입질(!!)이 오면 손을 위로 번쩍! 걸리면 한 손으로 릴을 빙글빙글 감아요'],
  },
  {
