...
class GameSettlementServiceTest {
    ...
    void 회원만_적재하고_게스트는_제외한다() {
        ...
        Map<Long, Integer> best = service.settleToDb(1L, LeaderboardMode.MULTI, List.of(
                new GameResultEntry(1, "2", "회원", 88, 5, true, 0, null),
                new GameResultEntry(2, "guest-ab12", "게스트", 50, 3, true, 0, null)));
    ...
    void 기존보다_높은_점수면_최고점_갱신하고_플레이수_증가() {
        ...
        service.settleToDb(1L, LeaderboardMode.MULTI, List.of(new GameResultEntry(1, "2", "회원", 88, 5, true, 0, null)));
    ...
    void 낮은_점수는_최고점을_낮추지_않는다() {
        ...
        service.settleToDb(1L, LeaderboardMode.MULTI, List.of(new GameResultEntry(1, "2", "회원", 40, 2, true, 0, null)));
