    ...
    <div class="hide-on-small">
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper">
          <button v-if="!isLoggedIn" @click="clickRegister">회원가입</button>
          <button v-if="!isLoggedIn" @click="clickLogin">로그인</button>
        </div>
      </div>
    </div>
      ...
      <div class="mobile-sidebar-wrapper" v-if="!state.isCollapse">
        <div class="mobile-sidebar">
          <div class="mobile-sidebar-tool-wrapper">
            ...
            <button v-if="!isLoggedIn" class="mobile-sidebar-btn login-btn" @click="clickLogin">로그인</button>
            <button v-if="!isLoggedIn" class="mobile-sidebar-btn register-btn" @click="clickRegister">회원가입</button>
          </div>
          <ul class="menu">
            <li
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const isLoggedIn = computed(() => store.getters['accountStore/isLoggedIn'])
    ...
    const menuSelect = function (item) {
      if (item.key === 'logout') {
    ...
    return { state, isLoggedIn, menuSelect, clickLogo, clickLogin, clickRegister, changeCollapse }
  }
}
</script>
