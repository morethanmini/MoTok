...
public class InvitationService {
     ...
     *
     * <p>수락/거절을 action으로 구분하지 않는다. 거절은 곧 "치운다"이고, 수락도 초대에 실린
     * inviteCode로 {@code join-by-invite-code}를 부르면서 함께 치우기 때문이다 — 프론트의 초대
     * 카드는 일회용이라 입장 성공 여부와 무관하게 사라진다(막혔으면 다시 초대받는다).
