...
.shop-page :deep(.app-page) { padding: 32px 0 26px; }.shop-page :deep(.hero), .shop-page :deep(.body) { padding-right: 46px; padding-left: 46px; }.shop-page :deep(.page-sticker) { display: none; }
