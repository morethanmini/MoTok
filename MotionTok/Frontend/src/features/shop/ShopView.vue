...
<template>
  <AppPage class="shop-page" title="상점" :back="false" title-style="none" max-width="1640px" :zoom="1">
    <template #hero>
...
/* 배경 도트·좌우 여백·상하 여백은 로비(.shell.px-paper-bg + .layout)를 기준값으로 맞춘다.
   background 축약형을 쓰면 px-party-bg의 도트까지 지워져 상점만 민무늬가 된다 — 색만 덮어쓴다. */
.shop-page { background-color: var(--c-paper); background-image: radial-gradient(rgba(56, 38, 61, .1) 1px, transparent 1px); background-size: 16px 16px; }.shop-page :deep(.app-page) { padding: 32px 0 26px; }.shop-page :deep(.hero), .shop-page :deep(.body) { padding-right: 46px; padding-left: 46px; }.shop-page :deep(.page-sticker) { display: none; }
