...
<template>
  <AppPage class="mypage" title="마이페이지" title-style="none" max-width="980px">
    <section class="mypage-titlebar">
      <div>
        <p>MY MOTION SPACE</p>
        <h1>{{ me.nickname }}의 마이페이지</h1>
        <span>{{ me.email ?? '소셜 계정' }}</span>
      </div>
      <div class="title-point"><CoinIcon :size="15" /> {{ me.pointBalance.toLocaleString() }}</div>
    </section>
...
/* Lobby board palette */
.mypage { background: #fff8e9; }.mypage :deep(.app-page) { padding-top: 34px; }.mypage :deep(.body) { max-width: 980px; }
.mypage-titlebar { display: flex; align-items: end; justify-content: space-between; gap: 16px; margin: 0 auto 18px; padding: 0 6px; }.mypage-titlebar p { margin: 0 0 8px; color: #a8704f; font-size: 9px; letter-spacing: 1px; }.mypage-titlebar h1 { margin: 0; color: #4b3429; font-family: var(--font-pixel); font-size: 20px; font-weight: 400; }.mypage-titlebar span { display: block; margin-top: 9px; color: #856957; font-size: 10px; }.title-point { display: flex; align-items: center; gap: 5px; padding: 9px 12px; border: 2px solid #9a6b4f; border-radius: 7px; background: #fff0b6; box-shadow: 2px 2px 0 #bd916e; color: #6b4634; font-family: var(--font-pixel); font-size: 11px; }
.grid { grid-template-columns: 330px minmax(0, 1fr); gap: 20px; align-items: start; }.grid :deep(.card) { border: 3px solid #9a6b4f; border-radius: 13px; background: #fffaf0; box-shadow: 5px 5px 0 #d5b28c; }.grid :deep(.card-head) { padding-bottom: 11px; border-bottom: 2px solid #ead5b8; }.grid :deep(.card-head h2) { color: #4b3429; font-size: 17px; }
.profile { padding: 2px; }.avatar { width: 72px; height: 72px; padding: 4px; border: 0; border-radius: 0; background: #5e4634; box-shadow: 3px 3px 0 #e3d8c7; clip-path: polygon(23px 0,49px 0,49px 4px,58px 4px,58px 9px,64px 9px,64px 15px,68px 15px,68px 23px,72px 23px,72px 49px,68px 49px,68px 58px,64px 58px,64px 64px,58px 64px,58px 68px,49px 68px,49px 72px,23px 72px,23px 68px,14px 68px,14px 64px,8px 64px,8px 58px,4px 58px,4px 49px,0 49px,0 23px,4px 23px,4px 14px,8px 14px,8px 8px,14px 8px,14px 4px,23px 4px); }.avatar-face { border-radius: 0; background: #f8dca5; clip-path: polygon(21px 0,47px 0,47px 4px,56px 4px,56px 9px,62px 9px,62px 15px,66px 15px,66px 21px,68px 21px,68px 47px,66px 47px,66px 56px,62px 56px,62px 62px,56px 62px,56px 66px,47px 66px,47px 68px,21px 68px,21px 66px,12px 66px,12px 62px,6px 62px,6px 56px,2px 56px,2px 47px,0 47px,0 21px,2px 21px,2px 12px,6px 12px,6px 6px,12px 6px,12px 2px,21px 2px); }.avatar-edit { border-color: #8e6049; background: #f7df9e; box-shadow: 2px 2px 0 #bd916e; }.nick { color: #503528; }.meta, .perm-desc, .perm-help, .cell-empty, .empty { color: #957967; }.point { border-color: #c79b77; border-radius: 8px; background: #fff0b6; }.point b { color: #8c593b; }.links :deep(.px-btn), .perm-card :deep(.px-btn) { border: 2px solid #9a6b4f; border-radius: 6px; box-shadow: 2px 2px 0 #bd916e; }.more { color: #9a6045; }.records th, .records td { border-bottom-color: #ead5b8; }.records th { color: #987b67; }.records td:last-child { color: #8b5d42; }.perm-state { border-color: #bc8c6a; border-radius: 6px; background: #f7df9e; color: #704c38; }.perm-state.granted { background: #dcecbf; color: #56743e; }
@media (max-width: 820px) { .mypage-titlebar { align-items: flex-start; flex-direction: column; }.grid { grid-template-columns: 1fr; } }
.mypage .avatar { padding: 3px; border: 2px solid #8e714e; border-radius: 50%; background: #fff0b9; clip-path: none; box-shadow: none; }.mypage .avatar-face { border-radius: 50%; background: #e8e3d9; clip-path: none; }
</style>
